                        ...
                        <div className="btn-group float-right mb-3">
                            <div className="btn-group" role="group" aria-label="Basic example">
                                <button type="button" className="btn btn-info" data-toggle="modal"
                                        data-target=".bs-example-modal-lg">New Role
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-12">
                        <div className="card">
                            <div className="card-body">
                                ...
                                <table id="selection-datatable" className="table dt-responsive nowrap w-100">
                                    <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Position</th>
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <p className="card-title-desc">
                                    ...
                                    action etc) can be assigned to individual
                                    cells, columns, rows or all cells.
                                </p>

                                <table id="key-datatable" className="table dt-responsive nowrap w-100">
                                    <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Position</th>
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <table id="state-saving-datatable"
                                       className="table activate-select dt-responsive nowrap w-100">
                                    <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Position</th>
